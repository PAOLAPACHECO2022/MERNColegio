...
const Aside = () => {
  ...
  return (
    ...
    <aside
      ...
      id="logo-sidebar"
      className="d-flex fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-gray-500 dark:border-gray-700"
      aria-label="Sidebar"
            ...
            <>
              ...
              <li>
                <button
                  type="button"
                  className="flex items-center w-full p-2 text-base font-normal text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                  onClick={() => setPerformancecDropdown(!performancecDropdown)}
                >
                  <svg
                    aria-hidden="true"
                    className="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                ...
                >
                  <li>
                    <p
                      className="flex items-center w-full p-2 text-base font-normal text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                      onClick={() => navigate("/gradesByLevel/Primaria/performancec")}
                    >
                      Primaria
                    </p>
                  </li>
                  <li>
                    <p
                      className="flex items-center w-full p-2 text-base font-normal text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                      onClick={() => navigate("/gradesByLevel/Secundaria/performancec")}
                    >
                      Secundaria
                    </p>
                  </li>
          ...
          {role === "Teacher" && (
            ...
            <li>
                ...
                >
                  ...
                  >
                    <path 
                    d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2zm0 2v.51l8 5 8-5V6H4zm16 12v-7.51l-7.39 4.62c-.33.21-.73.32-1.11.32s-.78-.11-1.11-.32L4 10.49V18h16z"></path>
                  </svg>
